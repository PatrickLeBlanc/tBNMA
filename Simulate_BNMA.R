...
jags_file = "C:/Users/psmit/Desktop/Research/NMA/jags/BNMA_Like_Norm_Trial_Two_Arm_Time_Sigmoidal_v2.bug"
...
#   tot_years = c(pred_x,obs_x)
#   
#   phi_vec = jags_fit_time$BUGSoutput$sims.matrix[,496 + k]
#   rho_vec = jags_fit_time$BUGSoutput$sims.matrix[,502+k]
#   psi_vec = jags_fit_time$BUGSoutput$sims.matrix[,502]
#   
#   
#   for(n in 1:nrow(d_mat)){
#     
